...
<div class="header_hist">
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col-11">
                        <h1 class="titulo_hist">História</h1>
                    </div>
                </div>
            </div>
            <div class="container text-center">
                <menu class="navbar navbar-expand-lg navbar-primary-hist">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="../paginas/home_noticias.php">História Geral</a></li>
            ...
            <div class="headerhomehist">
            <div class="container text-center">
                <menu class="navbar navbar-expand-lg navbar2-hist">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="historia_geral.php">História Geral</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="capela.php">Capela de Santo Antônio</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="brasital.php">Brasital</a>
                                </li>
