    ...
    <div class="container text-center">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <figure>
                        <img src="https://placekitten.com/303/313" alt="Imagem Via Placekitten">
                        <figcaption><a href="#">Serviços</a></figcaption>
                        </figure>
                    </section>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6">
                ...
                <section class = "padding">
                        <figure>
                        <img src="https://placekitten.com/303/313" alt="Imagem Via Placekitten">
                        <figcaption><a href="../paginas/contato.php">Contato</a></figcaption>
                        </figure>
                    </section>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6">
                <section class = "padding">
                        <figure>
                        <img src="https://placekitten.com/303/313" alt="Imagem Via Placekitten">
                        <figcaption><a href="../paginas/termos_de_uso.php">Termos de Uso</a></figcaption>
                        </figure>
                    </section>
                </div>
