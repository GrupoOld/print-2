        ...
        <div class="container text-center">
            <div class="row cl">
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <article>
                        <div class="container text-center">
                            <h5>CULTURA DE SÃO ROQUE</h5><br>
                        </div>
                        <div class="row fundobranco">
                            <img src="../images/capacultura.jpg" class="img-fluid"
                                alt="Imagem de Capa da Cultura, um bilhete antigo">
                            <p>A Divisão de Cultura da cidade de São Roque, no interior de São Paulo, é um órgão da
                                Prefeitura Municipal responsável por promover e fomentar as atividades culturais no
                                município. A Divisão é composta por uma equipe de profissionais qualificados, que atuam
                                nas áreas de música, dança, teatro, cinema, artes visuais, literatura, patrimônio
                                cultural e educação cultural.
                            </p>
                            <img src="../images/10conferencia.jpg" class="img-fluid"
                                alt="Arte sobre a décima conferência sobre Cultura">
                        </div>
                    </article>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <article>
                        <div class="container text-center">
                            <h5>LAZER EM SÃO ROQUE</h5><br>
                        </div>
                        <div class="row">
                            <div class="container text-center fundobranco">
                                <p>A Divisão de Lazer da cidade de São Roque, no interior de São Paulo, é um órgão da
                                    Prefeitura
                                    Municipal responsável por promover e fomentar as atividades de lazer no município. A
                                    Divisão é
                                    composta por uma equipe de profissionais qualificados, que atuam nas áreas de
                                    esporte, recreação e
                                    eventos.
                                </p>
                                <br>
                                <p>Centro de Lazer Bandeirantes - Localizado a 5 minutos do centro de São Roque</p>
                                <img src="../images/brinquedosbandeirantes.jpg" class="img-fluid"
                                    alt="Fotos de brinquedos coloridos em um local com grama e ao fundo uma rua tranquila">
                                <br>
                                <p>Praça Largo dos Mendes - Localizada no centro de São Roque</p>
                                <img src="../images/brinquedosmendes.jpg" class="img-fluid"
