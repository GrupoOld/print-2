    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <article>
                    <img src="../images/servicoerror.svg" class="img-fluid" alt="Erro a o abrir a página">
                    <p>
                    <h1>Estamos em manutenção!</h1>
                    </p>
                    <p>Por motivos não justificados, o aluno responsável por esta página trancou sua matricula, sendo, assim essa página está temporáriamente em manutenção para melhor atende-los.</p>
                    <p>Atenciosamente, CFFA - Criaturas Fofas Fedorentas do Abismo.
                </article>
            </div>
        </div>
    </div>
