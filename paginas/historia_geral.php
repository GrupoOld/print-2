        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <p>Fernão Paes de Barros, irmão de Pedro Vaz, se estabeleceu em São Roque e fundou o Sítio Casa e uma capela dedicada a Santo Antônio. Esta capela era um local de descanso para os bandeirantes que procuravam ouro e esmeraldas no Rio Tietê.</p>
                    <div class="container text-center">
                    <div class="row-fluid">
                        <br>
