...
<body>
    ...
    <main>
        ...
        <div class="container rigth">
            ...
            <h2><br>Notícias</h2><br>
            <h3><br>Notícias da Cidade</h3><br>
        </div>
        <div class="container">
            <div class="row">
               
                    <img src="https://placekitten.com/405/200" class="img-fluid" alt="Imagem de gatinho" width="400" height=>
        ...
        <div class="row">
            ...
            <div class="col-3 logof">
                <a class="navbar-brand" href="#">
                    <img src="../images/logo_ok.svg" alt="Logo GOLD" width="100" height="100">
                </a>
            </div>
        </div>
    </div>
