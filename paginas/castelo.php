...
<body>
    ...
    <article>
        ...
        <div class="container text-center">
            ...
            <h3><br>O CASTELO DE SÃO ROQUE</h3><br>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="row-fluid">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <br>
                    <img src="https://placekitten.com/400/300" class="img-fluid" alt="foto portal">
                    <img src="https://placekitten.com/400/301" class="img-fluid" alt="foto portal">
                </div>                                                                
            </div>
        </div>
        <div class="container text-center">
